...
def scrape(link, writefile):
    ...
    # base_url = 'https://www.athletic.net/TrackAndField/Division/Event.aspx?DivID=116302&Event=1&type=1&filter=11'
    base_url = link


    # Open a file to write
    #  with open('/Users/sam/Desktop/track csvs/athletes.csv', 'w', newline='', encoding='utf-8') as file:
    with open(writefile, 'w', newline='', encoding='utf-8') as file:
